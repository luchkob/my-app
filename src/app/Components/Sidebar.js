...
export default function Sidebar() {
  ...
  const [signout,setSigout]=React.useState(auth.user)
    ...
    <>
    {
        toggle?(
            ...
            <div className={styles.sidebar} >
                <div className="ml-auto w-fit px-4 z-10" onClick={()=> settoggle(!toggle)}>
                ...
                <ul className="flex font-extrabold  mt-3 h-full flex-col p-5 items-center gap-7">
                    ...
                    <li>FACEBOOK</li>
                     ...
                     {
                      signout ?(<></>):
                     ( <li className= "ml-auto relative mt-auto bottom-9  " onClick={func_signout }>
                     <svg width="40px" height="40px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
